...
<template>
  <div class="flex flex-col items-center justify-center gap-6 bg-muted p-6 min-h-svh md:p-10 bg-cover bg-center" style="background-image: url('/images/polbangtan.png');">
